...
class SeamarkTest {
  ...
  @Test
  void singleLight() {
    assertEquals("Fl.W.5s10M", Seamark.seamarkLightAbbr(Map.of(
  ...
  void groupHeightAndRange() {
    assertEquals("Fl(3)WRG.10s15m12M", Seamark.seamarkLightAbbr(Map.of(
  ...
  @Test
  void sectoredLight() {
    assertEquals("Fl.WRG.10s12M", Seamark.seamarkLightAbbr(Map.ofEntries(
  ...
  void sectoredLightNamesEachColourOnce() {
    assertEquals("Fl.WR.10s", Seamark.seamarkLightAbbr(Map.of(
  ...
  void colourAbbreviations() {
    assertEquals("BuOrP", Seamark.seamarkLightAbbr(Map.of(
      "seamark:light:colour", "blue;orange;pink")));
  }
