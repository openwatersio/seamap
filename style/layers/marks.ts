 ...
 */
const topmarkOffset: ExpressionSpecification = [
  "case",
  ["in", ["get", "shape"], ["literal", ["buoyant", "lattice", "pile", "tower"]]],
  ["literal", [0, -20]],
  ["in", ["get", "shape"], ["literal", ["stake", "pole"]]],
  ["literal", [0, -19]],
  ["==", ["get", "shape"], "conical"],
  ["literal", [0, -12]],
  ["==", ["get", "shape"], "can"],
...
const reflectorOffset: ExpressionSpecification = [
  "case",
  ["in", ["get", "shape"], ["literal", ["buoyant", "lattice", "pile", "tower"]]],
  ["literal", [0, -28]],
  ["in", ["get", "shape"], ["literal", ["stake", "pole"]]],
  ...
  ["==", ["get", "shape"], "can"],
  ["literal", [0, -16]],
  ["in", ["get", "shape"], ["literal", ["spherical", "barrel"]]],
  ["literal", [0, -17]],
  ["literal", [0, -30]],
];
...
const bodyShape: ExpressionSpecification = [
  "case",
  ["in", ["get", "shape"], ["literal", ["buoyant", "lattice"]]],
  "pile",
...
export function marks(): LayerSpecification[] {
  return [
    ...
    },
    {
      ...
      layout: {
        // colour combinations the sheet doesn't carry fall back to the shape's generic icon
        "icon-image": [
          "coalesce",
          [
            "image",
    ...
    },
    {
      ...
      layout: {
        // colour combinations the sheet doesn't carry fall back to the body's generic icon
        "icon-image": [
          "coalesce",
          [
            "image",
